...
describe('Rendering', () => {
  ...
  it('should render the first name input first', () => {
    const component = shallow(<SignupForm />)
    expect(
      component.find('#loginform > input[type="text"]').get(0).props.name
    ).toBe('firstName')
  })
  ...
  it('should render the last name input second', () => {
    const component = shallow(<SignupForm />)
    expect(
      component.find('#loginform > input[type="text"]').get(1).props.name
    ).toBe('lastName')
  })
  ...
  it('should render the email input third', () => {
    const component = shallow(<SignupForm />)
    expect(
      component.find('#loginform > input[type="text"]').get(2).props.name
    ).toBe('email')
  })
  ...
  it('should have a password input last', () => {
    const component = shallow(<SignupForm />)
    expect(
      component.find('#loginform > input[type="password"]').get(0).props.name
    ).toBe('password')
  })
})
